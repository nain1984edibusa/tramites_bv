...
Class clstu17respuestas extends clstramiterespuestas{	 
    ...
    public function tuc_insertar(){
        ...
        $bd->carga_valores("'".$this->getTuc_tipo_contestacion()."','".$this->getTuc_rutaarchivo()."','".$this->getMarco_legal()."','".$this->getTuc_cumple()."','".$this->getTuc_observaciones()."','".$this->getTu_id()."','".$this->getUsu_ejecutor()."', '".$this->getTuc_num_autorizacion()."', '".$this->getTuc_num_serie_autorizacion()."'"); // valores a insertae
        $bd->carga_campos("tuc_tipocontestacion,tuc_rutaarchivo,tuc_marcolegal, tuc_cumple, tuc_observaciones,tu_id,usu_ejecutor,tuc_num_autorizacion,tuc_num_serie_autorizacion"); // campos a ser insertados
    ...
    {
        $bd=Db::getInstance();
        $sql = "select resp17.tuc_num_autorizacion from _ct_tramite17_respuestas as resp17
        inner join _ct_tramite17 as tr17 on resp17.tu_id = tr17.tu_id
        where tr17.reg_id = ".$regional." order by resp17.tuc_num_autorizacion desc limit 1";
        //echo $sql;
