        ...
        if (($_GET["idt"] == 12)or($_GET["idt"] == 16)) {
            ?>
                                    ...
                                    <select id="tipo_contestacion" name="tipo_contestacion" class="tooltips-general material-control" data-toggle="tooltip" data-placement="top" required="">
                                        ...
                                        <option <?php if ($tipo_contestacion == "AFIRMATIVO"): echo "selected";
                                    endif ?>  value="AFIRMATIVO">AFIRMATIVO</option>
                                        <option <?php if ($tipo_contestacion == "NEGATIVO"): echo "selected";
                    endif ?> value="NEGATIVO">NEGATIVO</option>
